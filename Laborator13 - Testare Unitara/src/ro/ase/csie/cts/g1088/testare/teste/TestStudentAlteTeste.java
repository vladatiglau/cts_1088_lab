...
public class TestStudentAlteTeste {
	...
	@Test(expected = ExceptieVarsta.class)
	public void testSetVarstaRangePozitieMare() throws ExceptieVarsta{
		int varstaNoua = 200;
		student.setVarsta(varstaNoua);
	...
	@Test
	public void testSetVarstaBoundaryLimitaISuperioara() throws ExceptieVarsta {
	...
	@Test
	public void testSerVarstaInverse() throws ExceptieVarsta {
	...
	public void setGetNotaMinimaInverse() throws ExceptieNota {
		...
		note.add(radom.nextInt(Student.MAX_NOTA) + 1);
		note.add(radom.nextInt(Student.MAX_NOTA) + 1);
		note.add(radom.nextInt(Student.MAX_NOTA) + 1);
