...
import ro.ase.csie.cts.g1088.laborator3.faza3.servicii.ServiciuValidar;
...
public class TestProdus {
	...
	public void startUp() {
		...
		InterfataValidare serviciuValidare= new ServiciuValidar();
	...
	public static void main(String[] args) {
		Produs produs = new Produs(new StrategieMarketing2021(), new ServiciuValidar());
		try {
